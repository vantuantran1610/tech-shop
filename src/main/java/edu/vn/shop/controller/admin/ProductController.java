...
import edu.vn.shop.domain.Category;
import edu.vn.shop.domain.Product;
import edu.vn.shop.model.CategoryDto;
import edu.vn.shop.model.ProductDto;
import edu.vn.shop.service.CategoryService;
import edu.vn.shop.service.ProductService;
import edu.vn.shop.service.StorageService;
...
public class ProductController {
	...
	//su dung de hien thi tat ca cac category
	...
	public ModelAndView delete(ModelMap model, @PathVariable("productId") Long productId) throws IOException {
		...
		if(opt.isPresent()) {
			...
			model.addAttribute("messages", "product is deleted");
		}else {
			model.addAttribute("messages", "product is not Found!");
		}
	...
	public ModelAndView saveOrUpdate(ModelMap model, @Valid @ModelAttribute("product") ProductDto dto,
		...
		model.addAttribute("messages", "Product is saved!");
		return new ModelAndView("forward:/admin/products", model);
	}
